...
PARQUET_FILE_TEMPLATE_GCS = 'fhv_tripdata' + '_{{ execution_date.strftime(\'%Y-%m\') }}.parquet'
...
with local_workflow:
    ...
    cleaning_task = BashOperator(
        ...
        bash_command=f'rm {OUTPUT_FILE_TEMPLATE} {PARQUET_FILE_TEMPLATE}'
    )
